 ...
 { type, id } = req.query;
    ...
    try {
      ...
      if (type === 'text') {
        ...
        await collection.updateOne({ uniqueId: id }, { $set: { storyStatus: 'complete', story } });
      } else if (type === 'image') {
        ...
        await collection.updateOne({ uniqueId: id }, { $set: { imageStatus: 'complete', images: currentImages } });
      }
